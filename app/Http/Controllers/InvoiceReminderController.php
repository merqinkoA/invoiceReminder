     ...
     public function update(Request $request, int $invoice_reminder)
{
    ...
    $invoice_reminder->pi_submitted = $request->has('pi_submitted')? true : $invoice_reminder->pi_submitted;
    ...
    if (isset($validatedData['ses_migo_date'])) {
    $invoice_reminder->ses_migo_date = $validatedData['ses_migo_date'];
}
    $invoice_reminder->invoice_submitted = $request->has('invoice_submitted')? true : $invoice_reminder->invoice_submitted;
    if (isset($validatedData['po_number'])) {
    $invoice_reminder->po_number = $validatedData['po_number'];
}
if (isset($validatedData['ses_migo_number'])) {
