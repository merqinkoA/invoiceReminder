            ...
            <div class="col-6 col-md-12">
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        @endif
                        <form action="{{ route('invoiceReminder.update', $invoice_reminder->ir_id) }}" method="POST"
                            class="form">
                            @csrf
                            @method('put')
                            <div class="row">
                                ...
                                <div class="col-md-4 ">
                                    <div class="form-group">
                                        <input type="text" class="form-control form-control-sm" id="invoice_number"
                                            name="invoice_number" value="{{ $invoice_reminder->invoice_number }}" required>
                                        ...
                                        <select name="supplier_name" id="supplier_name" class="form-control">
                                            @foreach ($vendors as $vendor)
                                                <option value="{{ $vendor->id }}"
                                                    @if ($vendor->id == $invoice_reminder->supplier_name) selected @endif>
            ...
            secondSelect.appendChild(option);
                                ...
                                <div class="col-md-4 col-12">
                                    <div class="form-group">
                                        <input type="text" class="form-control form-control-sm" id="net_value"
                                            name="net_value" value="{{ $invoice_reminder->net_value }}">
                                ...
                                <div class="col-md-6 col-12">
                                    ...
                                    <input type="checkbox" id="pi_submitted" name="pi_submitted"{{ $invoice_reminder->pi_submitted==1? 'checked': '' }}> --}}
                                        ...
                                        <input type="checkbox" id="pi_submitted"
                                            name="pi_submitted"{{ $invoice_reminder->pi_submitted ? 'checked disabled' : '' }}>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="pr_number" name="pr_number" class="form-control p-4"
                                            data-role="tagsinput" value="{{ $invoice_reminder->pr_number }}" />
                                    </div>
                                </div>
                                ...
                                <div class="col 12 col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control form-control-sm" id="ses_migo_date"
                                            name="ses_migo_date" value="{{ $invoice_reminder->ses_migo_date }}">
                                    </div>
                                </div>
                                <div class="col-md-6 col-12">
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="checkbox" id="invoice_submitted" name="invoice_submitted"
                                            {{ $invoice_reminder->invoice_submitted == 1 ? 'checked disabled' : '' }}>
                                ...
                                <div class="col-md-3 col-12">
                                    <div class="form-group">
                                        ...
                                        <input id="po_number" name="po_number" type="text" class="form-control p-4"
                                            data-role="tagsinput" value="{{ $invoice_reminder->po_number }}" />
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3 col-12">
                                    <div class="form-group">
                                        ...
                                        <input id="ses_migo_number" name="ses_migo_number" type="text"
                                            ...
                                            value="{{ $invoice_reminder->ses_migo_number }}" />
                                    </div>
                                </div>
                                ...
                                <div class="col 12 col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control form-control-sm" id="due_date"
                                            name="due_date" value="{{ $invoice_reminder->due_date }}">
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group">
                                     ...
                                     --}}
                                        ...
                                        <select class="form-control form-control-sm" id="finance_status"
                                            name="finance_status">
                                            <option value="MIRO"
                                                {{ $invoice_reminder->finance_status == 'MIRO' ? 'selected' : '' }}>MIRO
                                            </option>
                                            <option value="Clearing"
                                                {{ $invoice_reminder->finance_status == 'Clearing' ? 'selected' : '' }}>
                                                Clearing</option>
                                            <option value="Done"
                                                {{ $invoice_reminder->finance_status == 'Done' ? 'selected' : '' }}>Done
                                            </option>
                                        </select>
                                    </div>
                                </div>
...
$(document).ready(function() {
    ...
    <script type='text/javascript'>
        $('#add_row_pr').click(function(event) {
            ...
            row = '';
            row +=
                '<tr><td><input type="text" class="form-control"></td><td ><input type="text" class="form-control"></td><td><input type="text" class="form-control"></td><td><input type="number" class="form-control"></td>';
