...
<head>
    ...
    <style type="text/css">
        ...
        .bootstrap-tagsinput .tag {
            /* Define styles for enabled tags */
            /* ... */
        }

        .bootstrap-tagsinput input[disabled] {
            /* Define styles for the input field when disabled */
            background-color: #f5f5f5;
            /* Example background color for disabled input */
            color: #777777;
            /* Example text color for disabled input */
            /* Add any other styling to make it visually distinct */
        }
    </style>
