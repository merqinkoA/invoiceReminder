...
@section('bot')
    <script type="text/javascript">
        var table = $('#invoice-table').DataTable({
            ...
            columns: [{
                ...
                },
                {
                    ...
                    name: 'vendor', // Update to use the new column
                    title: 'Vendor',
                },
                {
                    data: 'currency',
        ...
        function editForm(id) {
            ...
            $('#invoice_number, #vendor, #currency, #net_value, #pr_number').prop('readonly', false);
            $.ajax({
                ...
                success: function(data) {
                    ...
                    // Update tagsinput fields
                    // var emailto = data.email_to ? data.email_to.split(',') : [];
                    // $('#email_to').tagsinput('removeAll');
                    // for (var i = 0; i < emailto.length; i++) {
                    //     $('#email_to').tagsinput('add', emailto[i]);
                    // }
